...
import discult.modelapi.client.loaders.collada.data.ColladaMesh;
import discult.modelapi.client.loaders.collada.data.ColladaVertexSkinInfo;
import discult.modelapi.client.loaders.collada.data.Vertex;
...
public class GeometryLoader
{
    ...
    private final List<ColladaVertexSkinInfo> vertexWeights;
    ...
    public GeometryLoader(XmlNode geometryNode, List<ColladaVertexSkinInfo> vertexWeights) {
        this.vertexWeights = vertexWeights;
        this.meshData = geometryNode.getChild("geometry").getChild("mesh");
    }

    public ColladaMesh extractModelData(){
        readRawData();
        assembleVertices();
        ...
        return new ColladaMesh(verticesArray, texturesArray, normalsArray, indicesArray, jointIdsArray, weightsArray);
    }
    ...
    private void readPositions() {
        ...
        for (int i = 0; i < count/3; i++) {
           ...
           // Matrix4f.transform(CORRECTION, position, position);TODO come back to this if needed
    ...
    private float convertDataToArrays() {
        ...
        for (int i = 0; i < vertices.size(); i++) {
            ...
            ColladaVertexSkinInfo weights = currentVertex.getWeightsData();
